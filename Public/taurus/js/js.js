...
$(document).ready(function() {
    ...
    $(".block-remove").click(function() {
        $(this).parents(".block").fadeOut("slow",
        function() {
            $(this).remove()
        });
        return false
...
$(document).ready(function() {
    ...
    if ($("#dash_chart_1").length > 0) {
        var e = [[1, 25], [2, 28], [3, 22], [4, 18], [5, 30], [6, 18], [7, 14]];
    ...
    if ($("#dash_chart_2").length > 0) {
        var n = [[1, 1023], [2, 1244], [3, 1506], [4, 1330], [5, 1065], [6, 890], [7, 650]];
        var r = [[1, 868], [2, 1485], [3, 1355], [4, 1002], [5, 1200], [6, 755], [7, 800]];
    ...
    if ($("#chart_bar_1").length > 0) {
        var n = [[1, 25], [2, 28], [3, 22], [4, 18], [5, 30], [6, 18]];
        var r = [[1, 15], [2, 22], [3, 16], [4, 12], [5, 25], [6, 7]];
        var l = [[1, 10], [2, 16], [3, 10], [4, 6], [5, 18], [6, 3]];
    ...
    if ($("#chart_user_1").length > 0) {
        var n = [[1, 45], [2, 35], [3, 57], [4, 75], [5, 80]];
        var r = [[1, 55], [2, 65], [3, 43], [4, 25], [5, 20], [6, 75], [7, 85]];
        var l = [[6, 25], [7, 15]];
    ...
    var m = null;
    $("#chart_bar_1,#chart_bar_2,#chart_line_1,#dash_chart_1,#dash_chart_2,#chart_user_1").bind("plothover",
    function(e, t, n) {
...
$(document).ready(function() {
    ...
    if ($("#google_world_map").length > 0) {
        ...
        function m() {
            ...
            var i = [];
            google.maps.event.addListener(r, "places_changed",
            function() {
                var t = r.getPlaces();
                for (var n = 0,
                s; s = i[n]; n++) {
            ...
            google.maps.event.addListener(e, "bounds_changed",
            function() {
                var t = e.getBounds();
                r.setBounds(t)
            })
