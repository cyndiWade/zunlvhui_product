...
(function($) {
	$.extend({
		DialogBox: {
			defaults: {
				title: "谢谢使用Dialog-jQuery插件Edit By [小宇&lt;i@windyland.com&gt;]",
				name: "D" + new Date().getTime(),
				type: "text",
				content: "本插件改编自[漫画弹出层插件]<br/>欢迎访问: <a target='_blank' href='http://www.windyland.com'>http://www.windyland.com</a>",
				width: 600,
				height: 400,
				time: 0
			},
