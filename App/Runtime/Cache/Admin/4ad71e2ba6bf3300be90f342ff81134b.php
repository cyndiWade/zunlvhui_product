					...
					<div class="span12">
						...
						<div class="portlet box light-grey">
							<div class="portlet-title">
								<div class="caption"><i class="icon-globe"></i>节点列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">																		<a href="?s=/Admin/Rbac/node_edit/type/add/pid/0/level/1">
											<button id="sample_editable_1_new" class="btn green">
											添加系统<i class="icon-plus"></i>
											</button>										</a>								
									</div>								</div>
								<table class="table table-striped table-bordered table-hover sample_1">
									<thead>
										<tr>
											<th>节点名称</th>
											<th class="hidden-480">节点说明</th>
											<th class="hidden-480">节点等级</th>
											<th class="hidden-480">节点状态</th>
											<th >操作</th>
										</tr>
									</thead>
									<tbody>																		<?php if(is_array($node1)): $i = 0; $__LIST__ = $node1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX" onclick="javascript:window.location.href='?s=/Admin/Rbac/rbac_node/pid/<?php echo ($vo["id"]); ?>'">
											<td><?php echo ($vo["name"]); ?></td>
											<td class="hidden-480"><?php echo ($vo["title"]); ?></a></td>
											<td class="hidden-480"><?php echo ($vo["level"]); ?></td>
											<td class="center hidden-480">												<?php if(($vo["status"] == 0)): ?>启用												<?php else: ?>												<span style="color:red;">禁用</span><?php endif; ?>											</td>
											<td >												<?php if(($vo["status"] == 0)): ?><a href="?s=/Admin/Rbac/node_status/status/1/id/<?php echo ($vo["id"]); ?>">禁用</a>												<?php else: ?>												<a href="?s=/Admin/Rbac/node_status/status/0/id/<?php echo ($vo["id"]); ?>">启用</a><?php endif; ?>												|<a href="?s=/Admin/Rbac/node_edit/type/update/pid/<?php echo ($vo["id"]); ?>">编辑</a>												|<a href="?s=/Admin/Rbac/node_edit/type/delete/pid/<?php echo ($vo["id"]); ?>" class="check">删除</a>											</td>
										</tr><?php endforeach; endif; else: echo "" ;endif; ?>
									</tbody>
								</table>
							</div>							<!-- 第一级结束 -->													<!-- 第二级节点-->							<?php if($node2): ?><div class="portlet-body">								<div class="clearfix">									<div class="btn-group">										<a href="?s=/Admin/Rbac/node_edit/type/add/pid/<?php echo ($pid); ?>/level/2">											<button id="sample_editable_1_new" class="btn green">											添加新模块 <i class="icon-plus"></i>											</button>										</a>																	</div>								</div>								<table class="table table-striped table-bordered table-hover sample_1">									<thead>										<tr>											<th>节点名称</th>											<th class="hidden-480">节点说明</th>											<th class="hidden-480">节点等级</th>											<th class="hidden-480">节点状态</th>											<th >操作</th>										</tr>									</thead>									<tbody>																		<?php if(is_array($node2)): $i = 0; $__LIST__ = $node2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX" onclick="javascript:window.location.href='?s=/Admin/Rbac/rbac_node/pid/<?php echo ($vo["pid"]); ?>/pid2/<?php echo ($vo["id"]); ?>'">											<td><?php echo ($vo["name"]); ?></td>											<td class="hidden-480"><?php echo ($vo["title"]); ?></a></td>											<td class="hidden-480"><?php echo ($vo["level"]); ?></td>											<td class="center hidden-480">												<?php if(($vo["status"] == 0)): ?>启用												<?php else: ?>												<span style="color:red;">禁用</span><?php endif; ?>											</td>											<td >												<?php if(($vo["status"] == 0)): ?><a href="?s=/Admin/Rbac/node_status/status/1/id/<?php echo ($vo["id"]); ?>">禁用</a>												<?php else: ?>												<a href="?s=/Admin/Rbac/node_status/status/0/id/<?php echo ($vo["id"]); ?>">启用</a><?php endif; ?>												|<a href="?s=/Admin/Rbac/node_edit/type/update/pid/<?php echo ($vo["id"]); ?>">编辑</a>												|<a href="?s=/Admin/Rbac/node_edit/type/delete/pid/<?php echo ($vo["id"]); ?>" class="check">删除</a>											</td>										</tr><?php endforeach; endif; else: echo "" ;endif; ?>									</tbody>								</table>							</div>														<?php elseif($pid): ?>														<div class="portlet-body">								<div class="clearfix">									<div class="btn-group">										<a href="?s=/Admin/Rbac/node_edit/type/add/pid/<?php echo ($pid); ?>/level/2">											<button id="sample_editable_1_new" class="btn green">											添加新模块 <i class="icon-plus"></i>											</button>										</a>																	</div>								</div>								<table class="table table-striped table-bordered table-hover sample_1">									<thead>										<tr>											<th>节点名称</th>											<th class="hidden-480">节点说明</th>											<th class="hidden-480">节点等级</th>											<th class="hidden-480">节点状态</th>											<th >操作</th>										</tr>									</thead>									<tbody>																	</tbody>								</table>							</div><?php endif; ?>							<!-- 第二级结束-->																					<!-- 第三级节点 -->							<?php if($node3): ?><div class="portlet-body">								<div class="clearfix">									<div class="btn-group">														<a href="?s=/Admin/Rbac/node_edit/type/add/pid/<?php echo ($pid2); ?>/level/3">											<button id="sample_editable_1_new" class="btn green">											添加新方法 <i class="icon-plus"></i>											</button>										</a>																	</div>								</div>								<table class="table table-striped table-bordered table-hover sample_1">									<thead>										<tr>											<th>节点名称</th>											<th class="hidden-480">节点说明</th>											<th class="hidden-480">节点等级</th>											<th class="hidden-480">节点状态</th>											<th >操作</th>										</tr>									</thead>									<tbody>																		<?php if(is_array($node3)): $i = 0; $__LIST__ = $node3;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">											<td><?php echo ($vo["name"]); ?></td>											<td class="hidden-480"><?php echo ($vo["title"]); ?></a></td>											<td class="hidden-480"><?php echo ($vo["level"]); ?></td>											<td class="center hidden-480">												<?php if(($vo["status"] == 0)): ?>启用												<?php else: ?>												<span style="color:red;">禁用</span><?php endif; ?>											</td>											<td >												<?php if(($vo["status"] == 0)): ?><a href="?s=/Admin/Rbac/node_status/status/1/id/<?php echo ($vo["id"]); ?>">禁用</a>												<?php else: ?>												<a href="?s=/Admin/Rbac/node_status/status/0/id/<?php echo ($vo["id"]); ?>">启用</a><?php endif; ?>												|<a href="?s=/Admin/Rbac/node_edit/type/update/pid/<?php echo ($vo["id"]); ?>">编辑</a>												|<a href="?s=/Admin/Rbac/node_edit/type/delete/pid/<?php echo ($vo["id"]); ?>" class="check">删除</a>											</td>										</tr><?php endforeach; endif; else: echo "" ;endif; ?>									</tbody>								</table>							</div>														<?php elseif($pid2): ?>							<div class="portlet-body">								<div class="clearfix">									<div class="btn-group">																		<a href="?s=/Admin/Rbac/node_edit/type/add/pid/<?php echo ($pid2); ?>/level/3">											<button id="sample_editable_1_new" class="btn green">											添加新方法 <i class="icon-plus"></i>											</button>										</a>																	</div>								</div>								<table class="table table-striped table-bordered table-hover sample_1">									<thead>										<tr>											<th>节点名称</th>											<th class="hidden-480">节点说明</th>											<th class="hidden-480">节点等级</th>											<th class="hidden-480">节点状态</th>											<th >操作</th>										</tr>									</thead>									<tbody>																			</tbody>								</table>							</div><?php endif; ?>							<!-- 第三级结束 -->							
						</div>
