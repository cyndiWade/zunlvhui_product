					...
					<div class="span12">
						...
						<div class="portlet box blue">
							<div class="portlet-title">
								<div class="caption"><i class="icon-globe"></i>组列表</div>
								<div class="tools">
							...
							<div class="portlet-body">
								<div class="clearfix">
									<div class="btn-group">																		<a href="?s=/Admin/Rbac/groupEdit/type/add/pid/<?php echo ($pid); ?>">
											<button id="sample_editable_1_new" class="btn green">
											添加新组 <i class="icon-plus"></i>
											</button>										</a>								
									</div>								</div>
								<table class="table table-striped table-bordered table-hover sample_1">
									<thead>
										<tr>
											<th>组名</th>
											<th class="hidden-480">组说明</th>
											<th class="hidden-480">创建时间</th>
											<th class="hidden-480">修改时间</th>
											<th >操作</th>
										</tr>
									</thead>
									<tbody>																		<?php if(is_array($group_list)): $i = 0; $__LIST__ = $group_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr class="odd gradeX">
											<td><?php echo ($vo["name"]); ?></td>
											<td class="hidden-480"><?php echo ($vo["title"]); ?></a></td>
											<td class="hidden-480"><?php echo ($vo["create_time"]); ?></td>
											<td class="center hidden-480"><?php echo ($vo["update_time"]); ?></td>
											<td >												<a href="?s=/Admin/Rbac/group_node_two/group_id/<?php echo ($vo["id"]); ?>"><span class="wade_group_red">分配权限</span></a>												| <a href="?s=/Admin/Rbac/group_user/id/<?php echo ($vo["id"]); ?>">分配用户</a>												| <a href="?s=/Admin/Rbac/group/pid/<?php echo ($vo["id"]); ?>">查看子组</a>												| <a href="?s=/Admin/Rbac/groupEdit/type/update/id/<?php echo ($vo["id"]); ?>">编辑</a>												| <a href="?s=/Admin/Rbac/groupEdit/type/delete/id/<?php echo ($vo["id"]); ?>" class="check">删除</a>																							</td>
